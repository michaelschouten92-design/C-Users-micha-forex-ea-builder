...
export const STRATEGY_PRESETS: StrategyPreset[] = [
  // Simple entry strategy presets (template-first)
  {
    id: "simple-ema-crossover",
    name: "Simple EMA Crossover",
    description:
      "One-block EMA crossover strategy. Fast EMA(10) / Slow EMA(50) with built-in risk management. Just connect a timing filter and export.",
    tier: "FREE",
    buildJson: {
      version: "1.0",
      nodes: [
      ...
      edges: [{ id: "e1", source: "timing1", target: "ema-entry" }],
      viewport: { x: 0, y: 0, zoom: 0.8 },
      metadata: meta,
      settings: {
        magicNumber: 200001,
        comment: "Simple EMA Crossover",
        maxOpenTrades: 1,
        allowHedging: false,
        maxTradesPerDay: 0,
      },
  ...
  {
    id: "simple-rsi-reversal",
    name: "Simple RSI Reversal",
    description:
      "One-block RSI reversal strategy. Buys on RSI crossing above 30 (oversold), sells on RSI crossing below 70 (overbought). Built-in SL/TP.",
    tier: "FREE",
    buildJson: {
      version: "1.0",
      nodes: [
      ...
      edges: [{ id: "e1", source: "timing1", target: "rsi-entry" }],
      viewport: { x: 0, y: 0, zoom: 0.8 },
      metadata: meta,
      settings: {
        magicNumber: 200002,
        comment: "Simple RSI Reversal",
        maxOpenTrades: 1,
        allowHedging: false,
        maxTradesPerDay: 0,
      },
  ...
  {
    id: "simple-range-breakout",
    name: "Simple Range Breakout",
    description:
      "One-block Asian session range breakout strategy. Trades breakouts with ATR-based stop loss and 2:1 risk-reward take profit.",
    tier: "FREE",
    buildJson: {
      version: "1.0",
      nodes: [
      ...
      edges: [{ id: "e1", source: "timing1", target: "rb-entry" }],
      viewport: { x: 0, y: 0, zoom: 0.8 },
      metadata: meta,
      settings: {
        magicNumber: 200003,
        comment: "Simple Range Breakout",
        maxOpenTrades: 1,
        allowHedging: false,
        maxTradesPerDay: 0,
      },
