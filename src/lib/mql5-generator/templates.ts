...
export function generateFileHeader(ctx: GeneratorContext): string {
  ...
  const descLines = desc
    ? desc
        ...
        .join("\n")
    : `#property description "${safeName} — Generated by Algo Studio"`;
  return `//+------------------------------------------------------------------+
//|                                    ${safeName.padEnd(36)}|
//|                                    Generated by Algo Studio        |
//|                                    ${timestamp.substring(0, 19).padEnd(36)}|
//+------------------------------------------------------------------+
//| WARNING: If running multiple EAs on the same account, ensure each |
//| has a unique Magic Number to prevent trade conflicts.              |
//+------------------------------------------------------------------+
#property copyright "Algo Studio"
