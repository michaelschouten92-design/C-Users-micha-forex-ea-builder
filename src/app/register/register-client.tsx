  ...
  return (
    <div className="max-w-md w-full space-y-8 p-8 bg-[#1A0626] border border-[rgba(79,70,229,0.2)] rounded-xl shadow-[0_4px_24px_rgba(0,0,0,0.4)]">
      ...
      <div className="bg-[rgba(79,70,229,0.08)] border border-[rgba(79,70,229,0.2)] rounded-lg p-4">
        ...
        <p className="text-[10px] text-[#64748B] mt-2">No credit card required.</p>
      </div>
        ...
        <>
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-[#1A0626] text-[#64748B]">or register with email</span>
            </div>
          </div>
        </>
      )}
      ...
      <p className="text-xs text-center text-[#64748B]">
        ...
        <a href="/terms" target="_blank" className="text-[#A78BFA] hover:text-[#C4B5FD] underline">
          terms of service
        </a>{" "}
        and{" "}
        <a
      ...
      <p className="text-sm text-center text-[#94A3B8]">
        ...
        <Link href="/login" className="text-[#22D3EE] hover:underline font-medium">
          Sign in
        </Link>
      </p>
    </div>
