  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 bg-[#111114] border border-[rgba(255,255,255,0.06)] rounded-xl p-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            <div className="space-y-2">
              <div className="h-5 w-32 bg-[#18181B] rounded animate-pulse" />
              <div className="h-3 w-64 bg-[#18181B] rounded animate-pulse" />
            </div>
            <div className="h-10 w-28 bg-[#18181B] rounded-lg animate-pulse" />
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-[rgba(255,255,255,0.06)]">
            <div className="space-y-2">
              <div className="flex justify-between">
                <div className="h-3 w-16 bg-[#18181B] rounded animate-pulse" />
                <div className="h-3 w-12 bg-[#18181B] rounded animate-pulse" />
              </div>
              <div className="h-2 w-full bg-[#18181B] rounded-full animate-pulse" />
            </div>
            <div className="space-y-2">
              <div className="flex justify-between">
        ...
        <div className="flex justify-between items-center mb-6">
          <div className="h-8 w-36 bg-[#18181B] rounded animate-pulse" />
          <div className="h-10 w-32 bg-[#18181B] rounded-lg animate-pulse" />
        </div>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {[1, 2, 3].map((i) => (
            ...
            >
              <div className="h-5 w-3/4 bg-[#18181B] rounded animate-pulse" />
              <div className="h-3 w-1/2 bg-[#18181B] rounded animate-pulse" />
