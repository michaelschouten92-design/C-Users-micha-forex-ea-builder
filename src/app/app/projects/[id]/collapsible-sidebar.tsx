...
export function CollapsibleSidebar({ children, projectName }: CollapsibleSidebarProps) {
  ...
  return (
    <div
      className={`relative flex-shrink-0 transition-all duration-300 ${collapsed ? "w-0" : "w-72"}`}
    >
      ...
      {/* Sidebar content */}
      {!collapsed && (
        <div className="w-72 h-full bg-[#111114] border-l border-[rgba(79,70,229,0.2)] overflow-y-auto">
