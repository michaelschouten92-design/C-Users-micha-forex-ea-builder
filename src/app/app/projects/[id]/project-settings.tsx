          ...
          {showEdit ? (
            ...
            <div className="py-1">
              ...
              <button
                ...
                disabled={deleting}
                className="w-full text-left px-4 py-2.5 text-sm text-[#EF4444] hover:bg-[rgba(239,68,68,0.1)] flex items-center gap-2.5 disabled:opacity-50 transition-all duration-200"
              >
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
