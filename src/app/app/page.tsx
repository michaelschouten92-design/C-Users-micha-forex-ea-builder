...
function DashboardFallback({
  ...
  session: { user: { id: string; email?: string | null }; expires?: string } | null;
  error: string;
}) {
  console.error("[app/page] showing fallback — reason:", error);
  return (
    <div className="min-h-screen">
      {session && <AppNav session={session} tier="FREE" firstProjectId={null} />}
      <main id="main-content" className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
