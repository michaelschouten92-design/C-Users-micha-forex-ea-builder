          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mt-3">
            {STRATEGY_PRESETS.map((preset) => (
              <button
                ...
                disabled={loadingPreset !== null}
                className="text-left bg-[#1A0626] border border-[rgba(79,70,229,0.2)] rounded-lg p-4 hover:border-[rgba(79,70,229,0.4)] hover:shadow-[0_4px_16px_rgba(79,70,229,0.1)] disabled:opacity-50 transition-all duration-200 group"
              >
