    ...
    <div className="min-h-screen">
      ...
      <main className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center mb-6">
          <div className="h-8 w-32 bg-[#1E293B] rounded animate-pulse" />
          ...
          {[1, 2, 3, 4].map((i) => (
            ...
            >
              <div className="flex justify-between items-start">
                ...
                <div className="h-5 w-16 bg-[#1E293B] rounded-full animate-pulse" />
              </div>
              <div className="grid grid-cols-3 gap-3">
                {[1, 2, 3].map((j) => (
                  <div key={j} className="space-y-1">
                    <div className="h-2 w-12 bg-[#1E293B] rounded animate-pulse" />
              ...
              <div className="pt-4 border-t border-[rgba(79,70,229,0.15)]">
                <div className="grid grid-cols-4 gap-3">
                  {[1, 2, 3, 4].map((j) => (
                    <div key={j} className="space-y-1">
                      <div className="h-2 w-10 bg-[#1E293B] rounded animate-pulse" />
