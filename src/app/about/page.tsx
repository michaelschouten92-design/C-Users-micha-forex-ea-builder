        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-6 text-[#94A3B8] leading-relaxed">
            ...
            <p>
              ...
              crossovers, RSI reversals, range breakouts, trend pullbacks, MACD momentum, and
              RSI/MACD divergence. Each template produces a fully functional Expert Advisor that you
