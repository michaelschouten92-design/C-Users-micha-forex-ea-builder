        ...
        <div className="space-y-8 text-[#94A3B8] leading-relaxed">
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Account data:</strong> email address and (hashed) passwords when registering via email, or profile information from your OAuth provider (Google, GitHub).
              </li>
              <li>
                <strong>Project data:</strong> strategy names, descriptions, and builder configurations that you create.
              </li>
              <li>
                <strong>Payment data:</strong> processed by Stripe. We do not store credit card numbers. We only retain your Stripe customer ID and subscription status.
              </li>
              <li>
                <strong>Usage data:</strong> audit logs of actions (login, export, project changes) with anonymized IP addresses for security purposes.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 mt-2">
              ...
              <li><strong>Sentry</strong> - error reporting (no personal data)</li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 mt-2">
              ...
              <li><strong>Download a copy</strong> of your data (data export)</li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 mt-2">
              <li><strong>Session cookie</strong> (essential) - for authentication</li>
              <li><strong>CSRF token</strong> (essential) - for protection against cross-site request forgery</li>
              <li><strong>Cookie preference</strong> (essential) - to remember your cookie choice</li>
            </ul>
            <p className="mt-2">
