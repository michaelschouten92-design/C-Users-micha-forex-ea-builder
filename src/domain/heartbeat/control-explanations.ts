...
const CONTROL_EXPLANATIONS: Record<HeartbeatReasonCode, ControlExplanation> = {
  OK: {
    ...
    resolution: "No action required. The control layer is actively monitoring.",
  },
  STRATEGY_HALTED: {
    ...
    resolution: "Remove the operator hold from the strategy settings to resume execution.",
  },
  MONITORING_AT_RISK: {
    title: "Edge at Risk",
    explanation:
    ...
    resolution:
      "Review the strategy's performance metrics. If the edge has recovered, the system will automatically restore execution authority.",
  },
  MONITORING_SUPPRESSED: {
    ...
    resolution: "Wait for the suppression window to expire, or remove the suppression manually.",
  },
  STRATEGY_INVALIDATED: {
    ...
    resolution:
      "This is a permanent state. Create a new strategy version if you wish to resume trading.",
  },
  NO_INSTANCE: {
    ...
    resolution: "Deploy a live EA instance and ensure it sends heartbeat signals.",
  },
  CONFIG_UNAVAILABLE: {
    title: "Configuration Unavailable",
    explanation:
      "The governance configuration could not be loaded. The system defaults to PAUSE to prevent unmonitored execution.",
    resolution: "This is typically a transient system issue. If it persists, contact support.",
  },
  COMPUTATION_FAILED: {
    ...
    resolution:
      "This is typically a transient system issue. The next heartbeat cycle should resolve automatically.",
  },
  NO_HEARTBEAT_PROOF: {
    ...
    resolution:
      "Ensure your EA is running and sending heartbeat signals. The first decision will appear shortly.",
  },
  CONTROL_INCONSISTENCY_DETECTED: {
    ...
    resolution:
      "This indicates an internal logic divergence. The system should self-correct on the next heartbeat cycle. If it persists, contact support.",
  },
  AUTHORITY_UNINITIALIZED: {
    ...
    resolution:
      "Create a strategy and deploy a live EA instance to initialize the authority system.",
  },
};
